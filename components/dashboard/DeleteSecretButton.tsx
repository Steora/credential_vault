...
import { deleteSecret } from "@/app/actions/secrets";
...
export default function DeleteSecretButton({ secretId, secretKey }: Props) {
    ...
    <AlertDialog>
      ...
      <AlertDialogContent>
        <AlertDialogHeader>
          ...
          <AlertDialogTitle>Delete &ldquo;{secretKey}&rdquo;?</AlertDialogTitle>
          <AlertDialogDescription>
            The encrypted value will be permanently removed and cannot be recovered.
          </AlertDialogDescription>
        </AlertDialogHeader>
        <AlertDialogFooter>
